...
it('render the resource page', function () {
    get(CarResource::getUrl())
        ->assertOk();
});

it('can list car', function () {
...
it('render the edit page', function () {
    $car = Car::factory()
        ->for(Brand::factory())
        ->create();
...
it('can update a car', function () {
    ...
    Livewire::test(CarResource\Pages\EditCar::class, ['record' => $car->getRouteKey()])
        ->fillForm([
            'model' => $newCar->model,
            'year' => $newCar->year,
            'price' => $newCar->price,
...
it('can delete car images after car is delete', function () {
    $newCar = Car::factory()
        ->for(Brand::factory())
        ->make();
